                                 ...
                                 [ div [ class "panel-heading" ]
                                     [ div [ class "row" ]
                                         ...
                                         , div [ class "col-xs-4 text-right up7" ]
                                             [ a [ class "show-more" ]
                                                 [ text "Best of 128" ]
                                             , button [ class "btn btn-default btn-xs btn-action", type_ "button" ]
                                                 [ text "Add" ]
                                             ]
                                         ]
                                     ]
                                         ...
                                         [ div [ class "col-xs-12 col-md-6 " ]
                                             [ div [ class "opinion" ]
                                                 [ h4 [ class "pro" ]
                                                     [ text "Pro" ]
                                                 , p []
                                                     [ text "The most popular CMS to build an Open-Data platform. It is used with success by a wide number of public institutions around the world." ]
                                                 ]
                                             ]
                                         , div [ class "col-xs-12 col-md-6 " ]
                                             [ div [ class "opinion" ]
                                                 [ h4 [ class "con" ]
                                                     [ text "Con" ]
                                                 , p []
                                                     [ text "Compared to similar and younger solutions like uData it doesn’t have any social media capability." ]
                                                 ]
                                             ]
